...
- **TESTED (DEVELOPMENT ONLY):** eleven real land episodes, 67 questions per condition and 335 total
  A/B/C/D/E responses, cached single-sample model calls, parity audits, and provisional material
  error/coverage annotation. A has 4/67 errors, B 0/67, and C/D/E 1/67 each. Checked methods retain
  lower answerable-information coverage; eleven episode clusters do not support inference.
